          ...
          <div className="p-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">312.28€</div>
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    +57% que no mês passado
                  </p>
                </CardContent>
              </Card>
              <Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">3,874.32€</div>
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    +45% que no ano passado
                  </p>
                </CardContent>
              </Card>
              <Card>
